...
def write_to_db(offer_string):
    """
    Appends a new line to a file. No verification and it doesn't update
    old records.
    category_id for houses and apartments is hardcoded,
    so saving other categories would require code adjustments.
    :param offer_string:
    :return:
    """
...
def get_parsing_queries():
    ...
    Function to read and return active queries that should be used to get data
    about offers with all parameters.
